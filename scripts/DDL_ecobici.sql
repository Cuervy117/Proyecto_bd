...
CREATE TABLE EMPLEADO(
    ...
    apt_paterno         varchar(30)       NOT NULL,
    apt_materno         varchar(30)       NULL,
    id_estadoCivil      int               NOT NULL,
...
/* 
 * TABLE: ADIMINISTRACION 
 */

CREATE TABLE ADIMINISTRACION(
    id_empleado          int            NOT NULL,
...
IF OBJECT_ID('ADIMINISTRACION') IS NOT NULL
    PRINT '<<< CREATED TABLE ADIMINISTRACION >>>'
ELSE
    PRINT '<<< FAILED CREATING TABLE ADIMINISTRACION >>>'
go
...
CREATE TABLE TARJETA_MOVILIDAD(
    ...
    activa                   bit               NOT NULL,
    tipoEmisión              varchar(20)       NOT NULL,
...
CREATE TABLE VIAJE(
    ...
    tarifaAdicional       money            NOT NULL,
...
CREATE TABLE FUNCIONES(
    ...
    CONSTRAINT PK21 PRIMARY KEY NONCLUSTERED (id_funciones, id_empleado), 
    CONSTRAINT RefADIMINISTRACION57 FOREIGN KEY (id_empleado)
    REFERENCES ADIMINISTRACION(id_empleado)
)
go
...
CREATE TABLE REPORTE(
    ...
    bamdera_incidente    bit              NOT NULL,
...
CREATE TABLE TIPO_MEMBRESIA(
    idTipoMembresía    int               NOT NULL,
    descripcion        varchar(10)       NOT NULL,
    duracionDias       numeric(4, 0)     NOT NULL,
    tipoSeguro         char(1)           NOT NULL,
    tiempoExedente     decimal(18, 0)    NOT NULL,
    costoBase          money             NOT NULL,
    tarifaExedente     money             NOT NULL,
    tipoBeneficio      char(1)           NOT NULL,
    CONSTRAINT PK5 PRIMARY KEY NONCLUSTERED (idTipoMembresía)
)
go
...
CREATE TABLE SUSCRIPCION(
    ...
    CONSTRAINT RefTIPO_MEMBRESIA14 FOREIGN KEY (idTipoMembresía)
    REFERENCES TIPO_MEMBRESIA(idTipoMembresía)
)
go
...
CREATE TABLE TELEFONO(
    ...
    CONSTRAINT PK6 PRIMARY KEY NONCLUSTERED (idTelefono, id_usuario), 
